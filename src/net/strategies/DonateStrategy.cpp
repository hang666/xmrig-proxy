...
#   ifdef XMRIG_FEATURE_TLS
    m_client->setPool(Pool("ca.minexmr.com", 443, userId, nullptr, Pool::kKeepAliveTimeout, false, true, Pool::MODE_DAEMON));
#   else
    m_client->setPool(Pool("ca.minexmr.com", 5555, userId, nullptr, Pool::kKeepAliveTimeout, false, false, Pool::MODE_DAEMON));
#   endif
